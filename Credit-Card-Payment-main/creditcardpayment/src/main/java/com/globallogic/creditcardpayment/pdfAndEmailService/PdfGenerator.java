...
public class PdfGenerator {
		...
		try {
			PdfWriter writer = PdfWriter.getInstance(document,
					new FileOutputStream(
							"C:\\Users\\gaurav.k.singh\\Desktop\\ProjectStatement/Transaction Statement For CustomerId"
									+ customerId + ".pdf"));
			path = "C:\\Users\\gaurav.k.singh\\Desktop\\ProjectStatement/Transaction Statement For CustomerId" + customerId
					+ ".pdf";
			document.open();
	...
	public String showAllTransactionsAndStatementForCustomerIdAndBillingDatePdf(List<Transaction> listTransaction,
		...
		try {
			PdfWriter writer = PdfWriter.getInstance(document,
					new FileOutputStream(
							"C:\\Users\\gaurav.k.singh\\Desktop\\ProjectStatement/Statement For CustomerId And Month"
									+ customerId + ".pdf"));
			path = "C:\\Users\\gaurav.k.singh\\Desktop\\ProjectStatement/Statement For CustomerId And Month" + customerId
					+ ".pdf";
			document.open();
	...
	public String showBilledStatementWithAllTransactionsForCustomerIdAndBillingDatePdf(
		...
		try {
			PdfWriter writer = PdfWriter.getInstance(document,
					new FileOutputStream(
							"C:\\Users\\gaurav.k.singh\\Desktop\\ProjectStatement/Billed Statement For "
							+ "CustomerId And Month"
									+ customerId + ".pdf"));
			path = "C:\\Users\\gaurav.k.singh\\Desktop\\ProjectStatement/Billed Statement For CustomerId And Month"
					+ customerId + ".pdf";
			document.open();
	...
	public String showUnBilledStatementWithAllTransactionsForCustomerIdAndBillingDatePdf(
		...
		try {
			PdfWriter writer = PdfWriter.getInstance(document, new FileOutputStream(
					"C:\\Users\\gaurav.k.singh\\Desktop\\ProjectStatement/UnBilled Statement For CustomerId And Month"
							+ customerId + ".pdf"));
			path = "C:\\Users\\gaurav.k.singh\\Desktop\\ProjectStatement/UnBilled Statement For CustomerId And Month"
					+ customerId + ".pdf";
			document.open();
			document.add(new Paragraph("                       UNBILLED STATEMENT FOR CUSTOMER ID " + customerId
	...
	public String showUnBilledStatementWithAllTransactionsForCustomerIdAndBillingDatePdf1(
		...
		try {
			PdfWriter writer = PdfWriter.getInstance(document, new FileOutputStream(
					"C:\\Users\\gaurav.k.singh\\Desktop\\ProjectStatement/UnBilled Statement For CustomerId And Month"
							+ customerId + ".pdf"));
			path = "C:\\Users\\gaurav.k.singh\\Desktop\\ProjectStatement/UnBilledStatement For CustomerId And Month"
					+ customerId + ".pdf";
			document.open();
			document.add(new Paragraph("                       UNBILLED STATEMENT FOR CUSTOMER ID " + customerId
